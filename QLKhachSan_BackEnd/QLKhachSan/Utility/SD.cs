...
{ 
    public static class  SD
    {
        ...
        public const string Status_Booking_Draft     = "Draft";
        public const string Status_Booking_Pending   = "Pending";
        public const string Status_Booking_Confirmed = "Confirmed";
        public const string Status_Booking_Ongoing   = "Ongoing";
        public const string Status_Booking_Completed = "Completed";
