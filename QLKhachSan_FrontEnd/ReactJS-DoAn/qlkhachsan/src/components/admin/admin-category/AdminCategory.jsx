...
const AdminCategory = () => {
  ...
  const storedToken = localStorage.getItem("adminToken");
    ...
    const fetchCategories = async () => {
      try {
        ...
        showNotification("Lỗi khi tải danh mục: " + error.message);
      }
    };
  ...
  const handleAddCategory = async () => {
    try {
      ...
      setShowForm(false);
      fetchCategories();
      showNotification("success", "Thêm danh mục phòng thành công!");
    } catch (error) {
  ...
  const handleUpdateCategory = async () => {
    try {
      ...
      setShowForm(false);
      fetchCategories();
      showNotification("success", "Cập nhật danh mục phòng thành công!");
    } catch (error) {
  ...
  const handleDeleteCategory = async () => {
    try {
      ...
      setShowForm(false);
      fetchCategories();
      showNotification("success", "Xoá danh mục phòng thành công!");
    } catch (error) {
          ...
          <div className="p-6 border-b border-gray-200">
                  ...
                  {currentCategories.length === 0 ? (
                    ...
                    currentCategories.map((category, index) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-sm flex space-x-2 text-center">
                          <button
            ...
            <div className="flex items-center justify-between mt-6">
              <div className="text-sm text-gray-500">
                ...
                {Math.min(indexOfLastCategory, filteredCategories.length)} trong
